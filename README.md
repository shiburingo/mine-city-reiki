...
- **累積シソーラス** — Wikipedia・Wiktionary・Wikidata・WordNet・例規・会議録から出典付きで関連語を蓄積し、50万語を第1目標として日次更新します。50万語未満では加速収集し、到達後は通常予算へ自動復帰します。検索時は100万語超を想定したSQLite索引と語単位LRUキャッシュを使用します。
