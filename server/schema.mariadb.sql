...
CREATE TABLE IF NOT EXISTS law_synonyms (
  ...
  pair_term_low VARCHAR(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin AS (LEAST(canonical_term COLLATE utf8mb4_bin, synonym_term COLLATE utf8mb4_bin)) VIRTUAL,
  pair_term_high VARCHAR(191) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin AS (GREATEST(canonical_term COLLATE utf8mb4_bin, synonym_term COLLATE utf8mb4_bin)) VIRTUAL,
  created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
